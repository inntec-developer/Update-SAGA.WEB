...
export class ProductividadComponent implements OnInit {
  ...
  Generar(reclutador){
    ...
    this.servicio.getProActividad(inicio,final,rec)
    .subscribe( data => {
...
public columns: Array<any> = [
  ...
  { title: 'vacantes', className: 'text-success text-center', name: 'vacantes', filtering: { filterString: '', placeholder: 'Folio' } },
  { title: 'cubiertas', className: 'text-success text-center', name: 'cubiertas', filtering: { filterString: '', placeholder: 'cubiertas' } },
  { title: 'PUNTOS', className: 'text-info text-center', name: 'puntaje', filtering: { filterString: '', placeholder: 'puntos' } },
