...
export class ClienteComponent implements OnInit {
  ...
  Exportar(){
    ...
    this.General.forEach(item => {
      obj.push({
        ...
        'CUBIERTAS': item.cubiertas,
        'FALTANTES' : item.puntaje,
  ...
  Generar(){
    ...
    this.servicio.getClientes(inc,fin,"1")
    .subscribe( data => {
  ...
  LimpiaFiltro(valor){
    if(valor = 0){
      ...
      this.columns = [
        ...
        { title: 'POSICIONES', className: 'text-success text-center', name: 'numeropos', filtering: { filterString: '', placeholder: 'Numeropos' } },
        { title: 'CUBIERTAS', className: 'text-success text-center', name: 'cubiertas', filtering: { filterString: '', placeholder: 'Cubiertas' } },
        { title: 'FALTANTES', className: 'text-success text-center', name: 'puntaje', filtering: { filterString: '', placeholder: 'faltantes' } },
        { title: '% CUMPL.', className: 'text-info text-center', name: 'porcentaje', filtering: { filterString: '', placeholder: 'porcentaje' } },
      ];
    }
  }
