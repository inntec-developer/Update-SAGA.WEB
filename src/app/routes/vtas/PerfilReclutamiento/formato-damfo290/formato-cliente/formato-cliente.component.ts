...
export class FormatoClienteComponent implements OnInit {
  @Input() IdFormato: any;
  ...
  Telefonos: any;
  Contactos: any;
  isPerfilReclutamiento: boolean = true;
  DisableComponente: boolean = false;
  options: any;
    ...
    if (this.IdFormato != null) {
      ...
      this._servicePerfilR.getClienteId(this.IdFormato).subscribe(data => {
        ...
        if (data != null && data != 404) {
          ...
          this.formCliente.controls['RazonSocial'].setValue(this.Cliente['razonSocial']);
          this.formCliente.controls['NombreComercial'].setValue(this.Cliente['nombrecomercial']);
          this.formCliente.controls['RFC'].setValue(this.Cliente['rfc']);
          this.formCliente.controls['Giro'].setValue(this.Cliente['giroEmpresa']);
          this.formCliente.controls['Actividad'].setValue(this.Cliente['actividadEmpresa']);

          this._servicePerfilR.getInfoCliente(this.Cliente['clienteId']).subscribe(data => {
  ...
  filter() {
    var filter = this.formCliente.get('RazonSocial').value;
  ...
  selected(event: any) {
    ...
    this.formCliente.controls['NombreComercial'].setValue(this.Cliente[0]['nombrecomercial']);
    this.formCliente.controls['RFC'].setValue(this.Cliente[0]['rfc']);
    this.formCliente.controls['Giro'].setValue(this.Cliente[0]['giroEmpresa']);
    this.formCliente.controls['Actividad'].setValue(this.Cliente[0]['actividadEmpresa']);
