...
@Component({
  selector: 'app-perfil-gerenciales',
  templateUrl: './perfil-gerenciales.component.html',
  styleUrls: ['./perfil-gerenciales.component.scss']
})
export class PerfilGerencialesComponent implements OnInit, OnChanges {
  @Input() IdFormato: any;
