...
@Component({
  selector: 'app-perfil-cardinales',
  templateUrl: './perfil-cordinales.component.html',
  styleUrls: ['./perfil-cordinales.component.scss']
})
export class PerfilCordinalesComponent implements OnInit, OnChanges {
  @Input() IdFormato: any;
