...
export class CURPValidator {
    ...
    public ValidarCurp(nombre: string, paterno: string, materno: string, fechaNacimiento: Date, sexo: string, estadoNacimiento: string, curp: string, esMexicano: boolean) {
    ...
    public ValidarRFC(nombre: string, paterno: string, materno: string, fechaNacimiento: Date, sexo: string, estadoNacimiento: string, rfc: string) {
