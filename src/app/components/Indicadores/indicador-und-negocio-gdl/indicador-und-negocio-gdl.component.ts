      ...
      if (result != 404) {
        ...
        this.Data = {
          ...
          datasets: [{
            label: "Guadalajara",
            lineTension: 0.1,
            backgroundColor: "rgba(165, 103, 255, 0.2)",
            borderColor: "rgba(165, 103, 255, 1)",
            pointBackgroundColor: "rgba(165, 103, 255, 1)",
            pointBorderColor: "#fff",
            pointHoverRadius: 5,
            pointHoverBackgroundColor: "#fff",
            pointHoverBorderColor: "rgba(165, 103, 255, 1)",
