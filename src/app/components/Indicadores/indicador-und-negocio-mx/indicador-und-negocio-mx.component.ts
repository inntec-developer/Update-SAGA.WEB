      ...
      if (result != 404) {
        ...
        this.Data = {
          ...
          datasets: [{
            label: "México",
            lineTension: 0.1,
            backgroundColor: "rgba(31,224,247, 0.2)",
            borderColor: "rgba(31,224,247, 1)",
            pointBackgroundColor: "rgba(31,224,247, 1)",
            pointBorderColor: "#fff",
            pointHoverRadius: 5,
            pointHoverBackgroundColor: "#fff",
            pointHoverBorderColor: "rgba(31,224,247, 1)",
