...
export class AdminServiceService {
  ...
  private UrlGetDatosContratados = ApiConection.ServiceUrl + ApiConection.GetDatosContratados;
  private UrlGetDatosGafetes = ApiConection.ServiceUrl + ApiConection.GetDtosGafetes;
  private UrlGetDatosGafetesClave = ApiConection.ServiceUrl + ApiConection.GetDtosGafetesByClave;
  private UrlGetDatosIngresos = ApiConection.ServiceUrl + ApiConection.GetDtosIngresos;
  private UrlAgregarDatosContratados = ApiConection.ServiceUrl + ApiConection.AgregarDtosContratados;
  private UrlAgregarGafetes = ApiConection.ServiceUrl + ApiConection.AgregarGafetes;
  private UrlGetDocNecesarios = ApiConection.ServiceUrl + ApiConection.GetDocumentosNecesarios;
  private UrlActualizarDocumentos = ApiConection.ServiceUrl + ApiConection.ActualizarDocumentos;
  private UrlGetTotales = ApiConection.ServiceUrl + ApiConection.GetTotales;
  ...
  GetBG(nombre): Observable<any> {
     const params = new HttpParams().set('ruta', nombre);
  ...
  DownloadFiles(ruta): Observable<any> {
    const params = new HttpParams().set('file', ruta);
  ...
  UploadFileDocs( file: File, candidatoId, name ): Observable<any> {
    const formData = new FormData();
    formData.append('file', file, name + '_' + candidatoId );
    return this._httpClient.post(this.UrlUploadFile, formData );
  }
  ...
  UploadBG( file: File ): Observable<any> {
    const formData = new FormData();
    formData.append('file', file, ApiConection.ServiceUrlFileManager + file.name );
  ...
  downloadImage(ruta): Observable<any> {
    ...
    return this._httpClient.get(ApiConection.ServiceUrlFileManager + 
      '/img/ArteRequi/Arte/' + ruta, {headers: httpHeaders, responseType: 'blob'});
  }
  ...
  SendEmailRegister(data: any): Observable<any> {
    return this._httpClient.post(this.UrlSendEmailRegister, data, this.httpOptions);
  }
  ...
  AddUsers(data: any): Observable<any> {
    return this._httpClient.post(this.UrlAddUser, data);
  }
  ...
  DeleteUsuario(data: any): Observable<any> {
    const params =  new HttpParams().set('entidadId', data);
  ...
  GetByUsuario(depto: string): Observable<any> {
    const params = new HttpParams().set('depto', depto);
  ...
  UpdatePassword(data: any): Observable<any> {
    const params = new HttpParams().set('correo', data.Email).set('pass', data.Password);
    return this._httpClient.post(this.UrlUpdatePassword, data );
  }
  EnviaCorreo(correo: string, pass: string): Observable<any> {
    const params = new HttpParams().set('correo', correo).set('pass', pass);
    return this._httpClient.get(this.UrlSendEmail, {params: params});
  }
  GetDatosContratados(candidatoId): Observable<any> {
    const params = new HttpParams().set('candidatoId', candidatoId);
    return this._httpClient.get(this.UrlGetDatosContratados, {params: params, headers: this.httpOptions.headers});
  }
  GetDatosGafetes(): Observable<any> {
    return this._httpClient.get(this.UrlGetDatosGafetes, {headers: this.httpOptions.headers});
  }
  GetDatosGafetesClave(clave): Observable<any> {
    const params = new HttpParams().set('clave', clave);
    return this._httpClient.get(this.UrlGetDatosGafetesClave, {params: params, headers: this.httpOptions.headers});
  }
  GetDatosIngresos(): Observable<any> {
    return this._httpClient.get(this.UrlGetDatosIngresos);
  }
  GetTotales(): Observable<any> {
    return this._httpClient.get(this.UrlGetTotales);
  }
  AgregarDatosContratados(data: any): Observable<any> {
    return this._httpClient.post(this.UrlAgregarDatosContratados, JSON.stringify(data), this.httpOptions);
  }
  AgregarGafetes(data: any): Observable<any> {
    return this._httpClient.post(this.UrlAgregarGafetes, JSON.stringify(data), this.httpOptions);
  }

  GetDocNecesarios(candidatoId): Observable<any> {
    const params = new HttpParams().set('candidatoId', candidatoId);
    return this._httpClient.get(this.UrlGetDocNecesarios, {params: params, headers: this.httpOptions.headers});
  }
  ActualizarDocumentacion(datos): Observable<any> {
    return this._httpClient.post(this.UrlActualizarDocumentos, datos, this.httpOptions);
  }
